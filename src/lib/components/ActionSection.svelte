...
<section
	id="action"
	class="flex flex-col gap-y-6 bg-error-500 text-surface-800 text-center py-20 px-6 relative overflow-hidden"
>
	<h2 class="title-mobile">Ready to get <br />started?</h2>
